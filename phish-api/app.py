...
app = Flask(__name__)
CORS(app)
model = pickle.load(open('C:\\Users\\chaln\\OneDrive\\Desktop\\PhishSleuth-main\\phish-api\\SVM_Model.pkl', 'rb'))
...
def checkCSV(url):
    ...
    try:
        ...
        with open('phish-api\Web_Scrapped_websites.csv', 'r') as read_obj:
        ...
        print("CSV file 'Web_Scrapped_websites.csv' not found.")
        # Handle the missing file error gracefully
        flag = 1
    return flag
